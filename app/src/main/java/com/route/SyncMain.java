package com.route;
        ...
        import com.route.cosmosdb.AccountSettings;
...
//    private final String containerName = "FamilyContainer";
    ...
    private void createDatabaseIfNotExists() throws Exception {
        logger.info("Create database {} if not exists.", AccountSettings.databaseName);

        //  Create database if not exists
        //  <CreateDatabaseIfNotExists>
        CosmosDatabaseResponse cosmosDatabaseResponse = client.createDatabaseIfNotExists(AccountSettings.databaseName);
    ...
    private void createContainerIfNotExists() throws Exception {
        logger.info("Create container {} if not exists.", AccountSettings.containerName);

        //  Create container if not exists
        //  <CreateContainerIfNotExists>
        CosmosContainerProperties containerProperties =
                new CosmosContainerProperties(AccountSettings.containerName, "/lastName");
